...
namespace csapatMunka_CsB
{
    public class Movie
    {
        ...
        {
            return $"{Movie_Name};{Release_Date.Year};{Movie_Type};{Director};{Music_Composer};{Money_Spent.ToString("C0", new CultureInfo("us-US"))};{Income.ToString("C0", new CultureInfo("us-US"))}";
